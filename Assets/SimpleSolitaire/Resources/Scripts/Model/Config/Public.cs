...
namespace SimpleSolitaire.Model.Config
{
    public class Public
    {
        ...
        public static int TRIPEAKS_CARD_NUMS = 52;
        public static int PYRAMID_CARD_NUMS = 52;

        public static int PYRAMID_ACCEPT_NUMBERS_SUM = 13;
        ...
        public static JsonSerializerSettings UNDO_DATA_SETTINGS = new JsonSerializerSettings { TypeNameHandling = TypeNameHandling.All };
    }
}