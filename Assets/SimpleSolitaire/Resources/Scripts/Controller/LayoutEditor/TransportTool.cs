...
namespace SimpleSolitaire.Controller
{
    public class TransportTool : MonoBehaviour
    {
        ...
        public void SetCard(LayoutCard card, int siblingIndex)
        {
            Card = card;
        ...
        public void SetPosition(LayoutCard card, Vector2Int anchoredPos)
        {
            if (card == null)
            {
        ...
        private void SetCardAnchoredPos(LayoutCard card, Vector2Int anchoredPos)
        {
